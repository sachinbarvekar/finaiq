...
export type IconName = 
  ...
  | 'arrow-trending-up' | 'arrow-trending-down'
  ...
  | 'eye' | 'eye-off'
  // New icons for more actions menu
  | 'dots-vertical'
  ...
  | 'user-plus'
  // New icons for document views
  | 'view-list' | 'view-grid' | 'view-boards'
  // Generic Icons
  | 'information-circle' | 'x' | 'menu' | 'paper-airplane';
...
export const Icon: React.FC<IconProps> = ({ name, className = "w-6 h-6" }) => {
    const icons: Record<IconName, JSX.Element> = {
        ...
        'users': <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M15 21v-1a6 6 0 00-5.176-5.958" />,
        ...
        'workflow': <path strokeLinecap="round" strokeLinejoin="round" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />,
        ...
        'logo': <><path strokeLinecap="round" strokeLinejoin="round" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547a2 2 0 01-1.022.547m13.376 0l-2.387.477a6 6 0 01-3.86.517l-.318-.158a6 6 0 00-3.86.517l-2.387-.477m13.376 0a2 2 0 011.022.547l1.373 1.372a2 2 0 01.547 1.022l.477 2.387a6 6 0 01-.517 3.86l-.158.318a6 6 0 01-.517 3.86l-.477 2.387a2 2 0 01-.547 1.022l-1.373 1.372a2 2 0 01-1.022.547l-2.387.477a6 6 0 01-3.86-.517l-.318-.158a6 6 0 01-3.86-.517l-2.387-.477a2 2 0 01-1.022-.547l-1.373-1.372a2 2 0 01-.547-1.022l-.477-2.387a6 6 0 01.517-3.86l.158-.318a6 6 0 01.517-3.86l.477-2.387a2 2 0 01.547-1.022l1.373-1.372a2 2 0 011.022-.547M4.572 4.572a2 2 0 00.547 1.022l.477 2.387a6 6 0 00.517 3.86l.158.318a6 6 0 003.86.517l2.387.477a2 2 0 001.022.547l1.373-1.372a2 2 0 00.547-1.022l.477-2.387a6 6 0 00-.517-3.86l-.158-.318a6 6 0 00-3.86-.517l-2.387-.477a2 2 0 00-1.022-.547L4.572 4.572z" /></>,
        ...
        'access': <path strokeLinecap="round" strokeLinejoin="round" d="M8 11V7a4 4 0 118 0m-4 8v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z" />,
        'preferences': <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 16v-2m8-8h2M4 12H2m15.364 6.364l-1.414-1.414M6.343 6.343l-1.414-1.414m12.728 0l-1.414 1.414M6.343 17.657l-1.414 1.414M16 12a4 4 0 11-8 0 4 4 0 018 0z" />,
        ...
        'target': <><path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" d="M1.343 12C2.086 7.02 6.52 3 12 3s9.914 4.02 10.657 9-4.643 9-10.657 9S2.086 16.98 1.343 12z" /></>,
        ...
        'arrow-trending-up': <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 015.814-5.519l2.74-1.22m0 0l-3.75-.625m3.75.625V3.375" />,
        'arrow-trending-down': <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6L9 12.75l4.286-4.286a11.948 11.948 0 014.306 6.43l.776 2.898m0 0l3.182-5.511m-3.182 5.51l-5.511-3.181" />,
        ...
        'quickbooks': <path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM9.52 9.57c-.24-.26-.4-.6-.4-.97 0-.38.16-.71.4-.97.24-.26.56-.4.93-.4.38 0 .7.14.94.4.24.26.4.6.4.97 0 .37-.16.71-.4.97-.24.26-.56.4-.94.4-.37 0-.69-.14-.93-.4zm4.96 0c-.24-.26-.4-.6-.4-.97 0-.38.16-.71.4-.97.24-.26.56-.4.94-.4.37 0 .7.14.93.4.24.26.4.6.4.97 0 .37-.16.71-.4.97-.24.26-.56.4-.93-.4-.38 0-.69-.14-.94-.4zm-2.83 5.46c-.52 0-.9-.1-1.14-.3-.24-.2-.36-.48-.36-.85v-2.3H8.5v2.32c0 .74.25 1.34.75 1.8.5.45 1.15.68 1.95.68.71 0 1.3-.19 1.78-.57.47-.38.71-.9.71-1.55 0-.46-.14-.84-.41-1.15-.28-.31-.69-.47-1.25-.47H11.5v-1.1h.66c.55 0 .99-.15 1.3-.46.32-.3.48-.7.48-1.19 0-.57-.21-1.03-.64-1.38-.43-.35-1-.53-1.71-.53-.74 0-1.35.21-1.83.64-.48.43-.72.99-.72 1.69h-1.65c0-1.01.35-1.87 1.05-2.58.7-.71 1.6-1.07 2.7-1.07.95 0 1.75.25 2.4.76.65.51.98 1.2.98 2.06 0 .52-.16.97-.48 1.34-.32.37-.76.56-1.31.56h-.66v1.1h.16c.86 0 1.5.25 1.92.76.42.51.63 1.15.63 1.93 0 .73-.24 1.35-.72 1.85-.48.5-1.12.75-1.92.75z" />,
        'salesforce': <path fillRule="evenodd" clipRule="evenodd" d="M14.964 3.44C13.824 3.012 12.396 3 11.088 3 9.492 3 8.328 3.3 7.236 3.864c-1.116.576-1.932 1.488-2.316 2.652-.396 1.188-.3 2.616.108 3.936.42 1.344 1.224 2.412 2.292 3.12 1.092.72 2.376 1.128 3.696 1.128 1.62 0 2.82-.312 3.888-.912 1.08-.612 1.884-1.572 2.292-2.772.408-1.2.312-2.616-.108-3.936-.42-1.32-1.224-2.376-2.292-3.084zM12 14.424c-1.38 0-2.748-.492-3.792-1.428-.936-.84-1.56-2.028-1.764-3.372-.216-1.332.012-2.856.624-4.2.624-1.344 1.692-2.4 3.012-2.928 1.332-.54 2.856-.552 4.2-.036 1.344.516 2.4 1.572 2.928 2.892.54 1.332.552 2.856.036 4.2-.516 1.344-1.572 2.4-2.892 2.928A7.749 7.749 0 0112 14.424z" />,
        'dropbox': <path d="M7.71 4.5l4.29 2.86v4.28L7.71 8.78V4.5m4.29 2.86l4.29-2.86v4.29L12 11.64v-4.28M3.42 8.79l4.29-2.86v4.28L3.42 13.07V8.79m4.29 7.14l4.29-2.86v-4.28l-4.29 2.85v4.29M12 15.93l-4.29 2.86v-4.29l4.29-2.85v4.28m4.29-7.14l4.29 2.86v4.28l-4.29 2.86v-4.28L12 11.64m4.29-2.85l-4.29-2.86-4.29 2.86 4.29 2.85 4.29-2.85z" />,
        'download': <path strokeLinecap="round" strokeLinejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />,
        'reprocess': <path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h5M20 20v-5h-5M4 4a8 8 0 0111.45 1.45M20 20a8 8 0 01-11.45-1.45" />,
        ...
        'document-duplicate': <path strokeLinecap="round" strokeLinejoin="round" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />,
        'zoom-in': <><path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /><path strokeLinecap="round" strokeLinejoin="round" d="M10 7v3m0 0v3m0-3h3m-3 0H7" /></>,
        'zoom-out': <><path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /><path strokeLinecap="round" strokeLinejoin="round" d="M13 10H7" /></>,
        'chevrons-left': <path strokeLinecap="round" strokeLinejoin="round" d="M11 19l-7-7 7-7m8 14l-7-7 7-7" />,
        ...
        'eye-off': <><path strokeLinecap="round" strokeLinejoin="round" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a9.97 9.97 0 01-1.563 3.029m-2.201-1.201a5.002 5.002 0 01-4.455-4.455" /></>,
        ...
        'cpu-chip': <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 6.375c0 2.278-3.694 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0c0-2.278-3.694-4.125-8.25-4.125S3.75 4.097 3.75 6.375m16.5 0v11.25c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375m16.5 0v3.75m-16.5-3.75v3.75m16.5 0v3.75C20.25 16.153 16.556 18 12 18s-8.25-1.847-8.25-4.125v-3.75m16.5 0c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125" />,
        ...
        'puzzle-piece': <path strokeLinecap="round" strokeLinejoin="round" d="M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z" />,
        ...
        'linkedin': <><path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM6 9h4v12H6z" /><circle cx="4" cy="4" r="2" /></>,
        ...
        'chat-alt': <path strokeLinecap="round" strokeLinejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />,
        'api': <path strokeLinecap="round" strokeLinejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />,
        'shield-check': <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.917L12 23l9-2.083A12.02 12.02 0 0017.618 7.984z" />,
        'trending-up': <path strokeLinecap="round" strokeLinejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />,
        'pencil-alt': <path strokeLinecap="round" strokeLinejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />,
        'translate': <path strokeLinecap="round" strokeLinejoin="round" d="M3 5h12M9 3v2m4 13-4-4M19 5h-2a2 2 0 00-2 2v10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2z" />,
        ...
        'badge-check': <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />,
        ...
        'academic-cap': <><path strokeLinecap="round" strokeLinejoin="round" d="M12 14l9-5-9-5-9 5 9 5z" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222" /></>,
        'rocket-launch': <path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />,
        'user-plus': <path strokeLinecap="round" strokeLinejoin="round" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />,
        ...
        'view-boards': <path strokeLinecap="round" strokeLinejoin="round" d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2m8 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2" />,
        ...
        'paper-airplane': <path strokeLinecap="round" strokeLinejoin="round" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />,
    };
